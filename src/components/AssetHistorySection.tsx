          ...
          <TableBody>
            {historico.map((item) => (
              <TableRow key={item.historico_id}>
                ...
                <TableCell className="font-medium">{item.campo_alterado}</TableCell>
                <TableCell className="text-muted-foreground">
                  {item.campo_alterado === "Local do Equipamento" && item.valor_antigo
                    ? formatLocationLabel(item.valor_antigo)
                    : item.valor_antigo || "-"}
                </TableCell>
                <TableCell>
                  {item.campo_alterado === "Local do Equipamento" && item.valor_novo
