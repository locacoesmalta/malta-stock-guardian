          ...
          <AuthProvider>
            ...
            <Suspense fallback={<LoadingFallback />}>
              ...
              <Route 
                ...
                element={
                  <ProtectedLayout>
                    <PermissionRoute permission="can_edit_reports">
                      <ReportEdit />
                    </PermissionRoute>
                  </ProtectedLayout>
                } 
              ...
              <Route path="/admin/predictive-purchases" element={<ProtectedLayout><AdminRoute><PredictivePurchases /></AdminRoute></ProtectedLayout>} />
